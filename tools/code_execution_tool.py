...
_TOOL_STUBS = {
    ...
    "search_files": (
        "search_files",
        'pattern: str, target: str = "content", path: str = ".", file_glob: str = None, limit: int = 50, offset: int = 0, output_mode: str = "content", context: int = 0, order: str = "discovery", execution_target: str = None',
...
def execute_code(
    ...
    if env_type != "local":
        ...
        if inherited_target is None:
            return _execute_remote(code, task_id, enabled_tools, reset=bool(reset), mode=mode)
        return _execute_remote(
            code, task_id, enabled_tools, inherited_target, reset=bool(reset), mode=mode,
    ...
    try:
        ...
        rpc_thread = threading.Thread(
            ...
            kwargs={
                ...
                "execution_target_scope": inherited_target_scope,
