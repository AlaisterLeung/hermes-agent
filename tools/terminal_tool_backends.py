...
_DOCKER_KWARGS = (
    ("storage_task_id", "storage_task_id", None),
    ("legacy_storage_task_id", "legacy_storage_task_id", None),
...
def _build_local_env(*, cwd, timeout, local_config=None, **_):
    ...
    setattr(env, "_persistent", bool((local_config or {}).get("persistent", False)))
    return env
...
def _create_environment(env_type: str, image: str, cwd: str, timeout: int,
    ...
    return builder(env_type=env_type, image=image, cwd=cwd, timeout=timeout, cc=container_config or {},
                   ...
                   probe_only=probe_only, local_config=local_config)
