...
def update_provider_fragment(
    ...
    *,
    ...
    with registry_write_lock() as directory:
        ...
        # Validate the complete publication before the marker write below: this
        # preflight keeps legacy activation marker-only and preserves the complete
        # visible target set when a provider's valid configs exceed the fragment-wide byte limit.
