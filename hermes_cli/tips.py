...
TIPS = [
    ...
    'provider_routing.preferred_min_throughput / preferred_max_latency: prefer providers meeting throughput/latency thresholds (number = p50, or p50/p75/p90/p99 cutoffs).',    # --- TUI & Dashboard ---
