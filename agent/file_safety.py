...
def build_write_denied_paths(home: str) -> set[str]:
    ...
    hermes_files = (
        ".env", ".anthropic_oauth.json", os.path.join("cache", "bws_cache.enc.json"),
        # Keyed execution-target fingerprint secret. Exposing or replacing it
        # would let an untrusted tool forge persisted target identities.
