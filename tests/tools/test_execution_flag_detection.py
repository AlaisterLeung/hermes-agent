...
def test_benign_segment_scaling_benchmark():
    ...
    small, small_result = _time_benign_segments(1_000)
    large, large_result = _time_benign_segments(2_000)

    assert small_result == (False, None, None)
    assert large_result == (False, None, None)
    print(f"benign segment benchmark: 1k={small:.3f}s, 2k={large:.3f}s")
